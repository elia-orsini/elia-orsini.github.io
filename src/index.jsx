      ...
      <div className='flex flex-col sm:flex-row h-max min-h-screen min-w-screen bg-black '>
        <div className='flex basis-[calc(1/14*100%)] bg-black'>.</div>
          <div className='basis-[calc(1/14*100%)] bg-black text-white text-center sm:text-left'>
            ...
            <div className='font-inter text-gray-500 px-10 sm:px-0'>
            ...
            <Link to="/photography"><button className={`w-full text-center sm:text-left mt-3 sm:mt-10 ${currentPage === 1 ? 'font-black text-white' : ''}`} onClick={()=>setPhotographySubPage(0)}>photography</button></Link>
              ...
              <p className='hidden sm:block fixed bottom-10 ml-0 hover:text-white'>
                <a href="https://github.com/elia-orsini" target="_blank">
              ...
              <p className='hidden sm:block fixed bottom-10 ml-10 hover:text-white'>
                <a href="https://twitter.com/elig____" target="_blank">
              ...
              <p className='hidden sm:block fixed bottom-10 ml-20 hover:text-white'>
                <a href="mailto:elia.orsini@hotmail.com" target="_blank">
