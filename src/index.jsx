    ...
    <div className='flex font-ia flex-col sm:flex-row h-max min-h-screen min-w-screen bg-black '>
      ...
      <div className='basis-[calc(2/14*100%)] text-white text-center sm:text-left'>
        ...
        <div className='font-ia text-gray-500 px-10 sm:px-0 text-base sm:fixed'>
          ...
          <Link to="/web/design"><button className={`w-full text-left mt-3 sm:mt-10  ${currentPage === 3 ? 'font-black text-white' : ''}`} onClick={() => setDesignSubPage(0)}>design</button></Link>
          {currentPage === 3 ? (
            <>
          ...
          <Link to="/web/photography"><button className={`w-full text-left ${currentPage === 1 ? 'font-black text-white' : ''}`} onClick={() => setPhotographySubPage(0)}>photography</button></Link>
          {currentPage === 1 ? (
            <>
