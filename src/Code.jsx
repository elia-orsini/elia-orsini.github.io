...
export default function Code() {
  return (
    <div className="flex flex-col">
      <div className='flex flex-col sm:flex-row sm:mt-44 mt-2'>
        <div>
        ...
        <ul className="text-left sm:ml-20">
          ...
          <li className="py-2">
          <a href="https://r124.vercel.app" target="_blank"><h1 className="font-bold underline underline-offset-1 decoration-2">HousesOfRome map</h1></a>
