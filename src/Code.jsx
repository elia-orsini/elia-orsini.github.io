    ...
    <div className="font-ia flex flex-col w-full">
      ...
      <div className='flex flex-col sm:mt-44 mt-10'>
        ...
        <ul className="text-left">
          ...
          <li className="py-2">
            <a href="https://hor-map.vercel.app/" target="_blank" rel="noreferrer"><h1 className="font-black underline underline-offset-1 decoration-2">HoR Map</h1></a>
            <p className="text-sm text-gray-200">3D interactive map.</p>
            <p className="text-xs font-light text-gray-400">THREE.JS - BLENDER</p>
          </li>
          <li className="py-2">
            <a href="https://lazyllm.xyz/" target="_blank" rel="noreferrer"><h1 className="font-black underline underline-offset-1 decoration-2">lazyLLM</h1></a>
            <p className="text-sm text-gray-200">Tooling kit to create, test and analyse prompts on LLMs.</p>
            <p className="text-xs font-light text-gray-400">TYPESCRIPT - NEXT.JS - TAILWIND CSS</p>
          </li>
          <li className="py-2">
      ...
      <div className='flex flex-col mt-20'>
        ...
        <ul className="text-left block">
          <li className="py-2">
            <a href="https://www.insomniaevents.xyz/" target="_blank" rel="noreferrer"><h1 className="font-black underline underline-offset-1 decoration-2">Insomnia</h1></a>
            <p className="text-sm text-gray-200">website for Insomnia Events.</p>
      ...
      <div className='flex flex-col mt-20'>
        ...
        <ul className="text-left sm:pb-44 pb-10 block">
          <li className="py-2">
            <a href="https://www.archivepdf.net/" target="_blank" rel="noreferrer"><h1 className="font-black underline underline-offset-1 decoration-2">ARCHIVE.pdf</h1></a>
            <p className="text-sm text-gray-200">Archive Fashion Scans, Articles & Content for the World.</p>
            <p className="text-xs font-light text-gray-400">TYPESCRIPT - NEXT.JS - STRAPI</p>
          </li>
        </ul>
      </div>
    </div>
