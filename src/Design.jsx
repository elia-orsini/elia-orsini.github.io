        ...
        return (
          <>
            ...
            <div className='mx-auto my-auto flex flex-col gap-2 w-full h-max mt-[12rem] pt-2 px-3 overflow-scroll bg-black z-10 mb-20'>
              ...
              {/* <div className='relative'>
                <img src="/design/metal/300.jpg" layout="fill" objectFit="contain"/>
              </div> */}
            </div>
            ...
            <div className='mx-auto my-auto flex flex-col gap-2 w-full h-max mt-[12rem] pt-2 px-3 overflow-scroll bg-black z-10 mb-20'>
              ...
              <div className='relative'>
                <img src="/design/metal/288.jpg" layout="fill" objectFit="contain"/>
              </div>
              <div className='relative'>
              ...
              {/* <div className='relative'>
                <img src="/design/metal/299.jpg" layout="fill" objectFit="contain"/>
              </div> */}
              <div className='relative'>
      ...
      case 2:
        return (
          ...
          <div className='mx-auto my-auto flex flex-col gap-2 w-full h-max mt-[7rem] pt-2 px-3 overflow-scroll bg-black z-10 mb-20'>
            ...
            {/* <div className='relative'>
              <img src="/design/2d/15.jpg" layout="fill" objectFit="contain"/>
            </div> */}
          </div>
        </>
        )
